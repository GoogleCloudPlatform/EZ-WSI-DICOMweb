...
ACQUISITION_DATE = DicomTag(number='00080022', vr='DA')
ACQUISITION_DATE_TIME = DicomTag(number='0008002A', vr='DT')
STUDY_TIME = DicomTag(number='00080030', vr='TM')
ACQUISITION_TIME = DicomTag(number='00080032', vr='TM')
...
CONCATENATION_UID = DicomTag(number='00209161', vr='UI')
...
SERIES_INSTANCE_UID = DicomTag(number='0020000E', vr='UI')
REFERENCED_IMAGE_SEQUENCE = DicomTag(number='00081140', vr='SQ')
REFERENCED_SOP_INSTANCE_UID = DicomTag(number='00081155', vr='UI')

OPERATOR_IDENTIFICATION_SEQUENCE = DicomTag(number='00081072', vr='SQ')
PERSON_IDENTIFICATION_CODE_SEQUENCE = DicomTag(number='00401101', vr='SQ')
LONG_CODE_VALUE = DicomTag(number='00080119', vr='UC')
...
ICC_PROFILE = DicomTag(number='00282000', vr='OB')
OPTICAL_PATH_SEQUENCE = DicomTag(number='00480105', vr='SQ')

SHARED_FUNCTIONAL_GROUP_SEQUENCE = DicomTag(number='52009229', vr='SQ')
PIXEL_MEASURES_SEQUENCE = DicomTag(number='00289110', vr='SQ')

DIMENSION_ORGANIZATION_TYPE = DicomTag(number='00209311', vr='CS')
